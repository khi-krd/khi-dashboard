...
export interface DataGridProps<TData extends object> {
  ...
  table?: Table<TData>
  recordCount: number
  /** Row count for skeleton loading (defaults to min(8, pageSize)). */
...
function DataGridProvider<TData extends object>({
  ...
  if (props.tableLayout?.columnsResizable) {
    /* TanStack table runtime options object is mutated by design upstream. */
    // eslint-disable-next-line react-hooks/immutability -- align resize mode with DataGrid layout contract
