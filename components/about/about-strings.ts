export const NS = {
  ...
  form: {
    ...
    stats_empty: "هیچ ئامارێک نییە — دەتوانیت لە دوایدا زیاد بکەیت",
    stats_label_ckb: "ناونیشان (سۆرانی)",
    stats_label_kmr: "ناونیشان (کرمانجی)",
    stats_value: "ژمارە",
    stats_remove: "لابردن",
  ...
  block: {
    ...
    quote: "وتە",
    stat: "ئامار",
    body_placeholder_ckb: "ناوەرۆکی بلۆک لێرە بنووسە…",
    body_placeholder_kmr: "Naveroka bloka li vir binivîse…",
    quote_placeholder_ckb: "دەقی وتە لێرە بنووسە…",
    quote_placeholder_kmr: "Nivîsa gotinê li vir binivîse…",
  },
  validation: {
