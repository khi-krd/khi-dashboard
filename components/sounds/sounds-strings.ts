...
export const NS = {
  ...
  reklam: {
    page: {
      title: "ڤیدیۆی ریکلامی دەنگ",
      subtitle: "یەک ڤیدیۆی گشتی بۆ پەڕەی سەرەکیی دەنگەکان — تەنها دەتوانرێت بگۆڕدرێت",
    },
    link: "ڤیدیۆی ریکلام",
    helper: "MP4، WEBM یان MOV",
    ...
    empty: {
      ...
      subtitle: "ڤیدیۆیەک بار بکە بۆ پیشاندان لە پەڕەی سەرەکیی دەنگەکان",
    },
    delete: {
      title: "سڕینەوەی ڤیدیۆی ریکلام؟",
      body: "ئەم کردارە ناتوانرێت بگەڕێندرێتەوە. ڤیدیۆکە لە سیستەم و لە کۆگاکە دەسڕێتەوە.",
    },
    meta: {
      size: "قەبارە",
      mime: "جۆری فایل",
  ...
  toast: {
    ...
    reklam_created: "ڤیدیۆی ریکلام بارکرا",
    reklam_updated: "ڤیدیۆی ریکلام نوێکرایەوە",
