...
export const NS = {
  ...
  page: {
    title: "دەنگەکان",
    subtitle: "بەڕێوەبردنی هەموو دەنگ، شیعر و مووسیقا بڵاوکراوەکان",
  },
  topics: {
    page: {
  ...
  state: {
    ...
    toggle: {
      helper:
        "تاک: یەک پارچەی دەنگی — ئەلبووم: کۆمەڵێک پارچە لە یەک ئەلبوومدا ڕێکخراون",
    },
    switch: {
      warning:
        "گۆڕین بۆ تاک، زانیاری ئەلبووم (ناو، ساڵ، CD، کۆی پارچە) دەسڕێتەوە کاتێک پاشەکەوت دەکەیت.",
    },
    context: {
  ...
  filter: {
    search_placeholder: "گەڕان لە ناونیشان، خوێنەر، تاگ، یان کلیلەوشە",
  ...
  field: {
    ...
    sound_type_helper: "بۆ نموونە: شیعر، مووسیقا، فۆلکلۆر، ئاینی، وتار",
  ...
  attachment: {
    ...
    empty:
      "هیچ پاشکۆیەک نییە — وەک بڕۆشێری PDF یان ڤیدیۆی پێشکەشکراو زیاد بکە",
  },
  brochure: {
  ...
  topic: {
    empty: "بێ بابەت",
    helper: "بابەتەکان بۆ پۆلبەندی دەنگەکانن — هەڵبژاردن یان دروستکردنی نوێ",
  ...
  help: {
    save_requirements:
      "بۆ پاشەکەوتکردن: جۆری دەنگ، دۆخ، لانیکەم زمانێک، ناونیشان و لانیکەم یەک پارچە پێویستن.",
  },
  system: {
    id: "ناسنامە",
