...
import { UserIcon, MultiplicationSignIcon, AlertCircleIcon } from "@hugeicons/core-free-icons"
        ...
        >
          ...
          {previewUrl ? (
            ...
            <div className="flex h-full w-full items-center justify-center">
              <HugeiconsIcon icon={UserIcon} strokeWidth={2} className="text-muted-foreground size-6" />
            </div>
          )}
        </div>
