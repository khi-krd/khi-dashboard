...
import { ImageIcon, Upload01Icon, MultiplicationSignIcon, CloudUploadIcon, AlertCircleIcon } from "@hugeicons/core-free-icons"
        ...
        {hasImage ? (
              ...
              {imageLoading && (
                <div className="bg-muted absolute inset-0 flex animate-pulse items-center justify-center">
                  <div className="text-muted-foreground flex flex-col items-center gap-2">
                    <HugeiconsIcon icon={ImageIcon} strokeWidth={2} className="size-5" />
          ...
          >
            <div className="bg-primary/10 rounded-full p-4">
              <HugeiconsIcon icon={CloudUploadIcon} strokeWidth={2} className="text-primary size-8" />
            </div>
