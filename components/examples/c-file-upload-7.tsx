...
import { MultiplicationSignIcon, CloudUploadIcon, ImageIcon, CancelCircleIcon, AlertCircleIcon } from "@hugeicons/core-free-icons"
            ...
            >
              <CardContent className="flex items-center gap-2 p-3">
                <div className="border-border rounded-md flex size-[32px] shrink-0 items-center justify-center border">
                  <HugeiconsIcon icon={ImageIcon} strokeWidth={2} className="text-muted-foreground size-4" />
                </div>
