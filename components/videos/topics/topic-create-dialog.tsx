...
import { useCreateTopicMutation } from "@/hooks/useVideos"
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md rounded-lg" dir="rtl">
        <form onSubmit={onSubmit}>
          <DialogHeader>
            <DialogTitle>{NS.topic.create_title}</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="topic-name-ckb">{NS.topic.name_ckb}</Label>
              <Input
                id="topic-name-ckb"
                value={nameCkb}
            ...
            <div className="space-y-2">
              <Label htmlFor="topic-name-kmr">{NS.topic.name_kmr}</Label>
              <Input
                id="topic-name-kmr"
                dir="ltr"
                value={nameKmr}
