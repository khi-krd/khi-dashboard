...
export const NS = {
  ...
  topics: {
    page: {
      ...
      subtitle: "بەڕێوەبردنی بابەتە پۆلبەندییەکانی ڤیدیۆ",
    },
  ...
  type: {
    ...
    toggle: {
      helper:
        "فیلم: یەک ڤیدیۆ بە یەک سەرچاوە — ڤیدیۆ کلیپ: کۆمەڵێک کلیپی ڕێکخراو",
    },
    switch: {
  ...
  field: {
    ...
    topic_helper:
      "بابەتەکان بۆ پۆلبەندی ڤیدیۆکانن — هەڵبژاردن یان دروستکردنی نوێ",
    album: {
  ...
  clip: {
    empty: "هیچ کلیپێک نییە — یەکەم کلیپت زیاد بکە",
    empty_cta: "کلیپی نوێ",
  ...
  topic: {
    empty: "بێ بابەت",
    helper: "بابەتەکان بۆ پۆلبەندی ڤیدیۆکانن",
    add: "بابەتی نوێ",
