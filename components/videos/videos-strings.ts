...
export const NS = {
  ...
  /**
   * The homepage Film section's background video — a singleton, not a
   * publishment. Copy mirrors the sound promo screen; only the composition
   * guidance differs, because this one plays under the film cards.
   */
  reklam: {
    page: {
      title: "ڤیدیۆی پاشبنەمای فیلم",
      subtitle:
        "یەک ڤیدیۆی گشتی کە لە پشتی کارتەکانی فیلمدا لە پەڕەی سەرەکیدا کار دەکات — بێدەنگ و دووبارەبووەوە",
    },
    link: "ڤیدیۆی پاشبنەما",
    helper: "تەنها MP4",
    max_size: (size: string) => `زۆرترین ${size}`,
    notes: [
      "بێدەنگ و بەردەوام دووبارە دەبێتەوە — هیچ دەنگێکی لێ نابیسترێت.",
      "ناوەڕاست و خوارەوەی وێنەکە بەتاڵ بهێڵەوە — کارت و دەق لەسەریان دادەنرێن.",
      "قەبارەکەی بچووک بهێڵەوە — هەموو سەردانکەرێک دایدەبەزێنێت.",
      "بەتاڵی کێشە نییە — بەبێ ڤیدیۆ بەشەکە لەسەر پاشبنەمایەکی تاریکی سادە دەردەکەوێت.",
    ],
    upload: "بارکردنی ڤیدیۆ",
    replace: "گۆڕینی ڤیدیۆ",
    uploading: "بارکردن…",
    drop_hint: "ڤیدیۆکە ڕاکێشە ئێرە یان کرتە بکە بۆ هەڵبژاردن",
    ...
    empty: {
      title: "هیچ ڤیدیۆیەکی پاشبنەما نییە",
      subtitle:
        "ڤیدیۆیەک بار بکە بۆ پشتی بەشی فیلم لە پەڕەی سەرەکیدا — یان بەتاڵی بهێڵەوە",
    },
    delete: {
      title: "سڕینەوەی ڤیدیۆی پاشبنەما؟",
      body: "ئەم کردارە ناتوانرێت بگەڕێندرێتەوە. بەشی فیلم لەسەر پاشبنەمایەکی تاریکی سادە دەردەکەوێت.",
    },
    meta: {
      size: "قەبارە",
      mime: "جۆری فایل",
  ...
  toast: {
    ...
    reklam_created: "ڤیدیۆی پاشبنەما بارکرا",
    reklam_updated: "ڤیدیۆی پاشبنەما نوێکرایەوە",
