...
export function VideoCoverSlot({
  label,
  helper,
  isHoverSlot,
  inactive,
  ...
  return (
    ...
    >
      {inactive ? (
        <p className="bg-background/80 text-muted-foreground absolute inset-0 z-10 flex items-center justify-center rounded-lg text-center text-[10px]">
          {NS.cover.lang_inactive}
        </p>
      ) : null}
      ...
      <div
        className={cn(
          "relative aspect-video overflow-hidden rounded-lg border border-dashed transition-colors",
