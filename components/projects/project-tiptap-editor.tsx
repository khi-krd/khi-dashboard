...
export function ProjectTiptapEditor({
  value,
  onChange,
  placeholder,
  lang,
  ...
  const ph =
    placeholder ?? (lang === "CKB" ? NS.field.body_ckb : NS.field.body_kmr)
    ...
    <TooltipProvider delay={300}>
      <div className="mt-6">
        <div className="border-border bg-background/95 supports-backdrop-filter:backdrop-blur sticky top-14 z-20 mb-3 flex flex-wrap items-center gap-0.5 rounded-lg border p-1">
          <ToolbarBtn label="پەراگراف">
            <span className="font-mono text-xs">P</span>
          </ToolbarBtn>
          <ToolbarBtn label="سەرناون H1">
            <span className="font-mono text-xs">H1</span>
          </ToolbarBtn>
          <ToolbarBtn label="سەرناون H2">
            <span className="font-mono text-xs">H2</span>
          </ToolbarBtn>
          <ToolbarBtn label="سەرناون H3">
        ...
        <div
          ...
          data-placeholder={ph}
          className={cn(
            "project-editor-body prose prose-sm md:prose-base max-w-none dark:prose-invert",
            "min-h-[480px] focus:outline-none",
          )}
