...
export function ServiceListLangChips({ langs }: { langs: Language[] }) {
...
export function ServiceLanguageChipRow({ langs }: { langs: Language[] }) {
  return <ServiceListLangChips langs={langs} />
}
