...
export const NS = {
  ...
  validation: {
    itemSourceRequired: "هەر وێنەیەک پێویستی بە سەرچاوەیەکە",
    albumRequired: "لانیکەم یەک وێنە پێویستە",
  ...
  help: {
    save_requirements:
      "بۆ پاشەکەوتکردن: جۆر، لانیکەم زمانێک، ناونیشان و لانیکەم یەک وێنە پێویستن.",
  },
  system: {
    id: "ناسنامە",
